-- =====================================================
-- FIX TASK DELETION BUG (Data Leak)
-- This replaces the SECURITY DEFINER with SECURITY INVOKER
-- ensuring that the function respects Row Level Security
-- and stops showing tasks the user doesn't have access to/cannot delete.
-- =====================================================
